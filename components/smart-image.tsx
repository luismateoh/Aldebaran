...
export default function SmartImage({
  ...
  return (
    <div className={cn("relative overflow-hidden", className)}>
      {isLoading && (
        <div 
          className="absolute inset-0 flex animate-pulse items-center justify-center bg-gradient-to-br from-blue-100 to-green-100"
          style={{ width, height }}
        >
          <div className="text-center">
            <div className="mx-auto mb-2 size-12 animate-spin rounded-full border-4 border-blue-500 border-t-transparent"></div>
      ...
      {hasError && !isLoading && (
        ...
        >
          <div className="p-4 text-center">
            <div className="mx-auto mb-3 flex size-16 items-center justify-center rounded-full bg-gray-300">
