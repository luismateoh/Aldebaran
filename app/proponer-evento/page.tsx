...
import { ArrowLeft, Send, Calendar, MapPin, User, Globe, Users, Zap, CheckCircle, Rocket } from 'lucide-react'
    ...
    <div className="container max-w-4xl mx-auto py-8 space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 mb-8">
          <div className="text-center p-6 border rounded-lg bg-blue-50">
            ...
            <h3 className="font-semibold text-blue-900">Para la Comunidad</h3>
            <p className="text-sm text-blue-700">Tu propuesta ayuda a miles de corredores</p>
          </div>
          ...
          <div className="text-center p-6 border rounded-lg bg-green-50">
            ...
            <h3 className="font-semibold text-green-900">Revisión Rápida</h3>
            <p className="text-sm text-green-700">Revisamos y publicamos en 24-48 horas</p>
          </div>
          ...
          <div className="text-center p-6 border rounded-lg bg-purple-50">
            ...
            <h3 className="font-semibold text-purple-900">Siempre Actualizado</h3>
            <p className="text-sm text-purple-700">Información verificada y confiable</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900">¿Qué pasa después?</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-sm font-bold">1</div>
              <p className="text-sm text-gray-700"><strong>Revisión:</strong> Verificamos la información en 24-48 horas</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center text-sm font-bold">2</div>
              <p className="text-sm text-gray-700"><strong>Aprobación:</strong> Te notificamos el estado de tu propuesta</p>
            </div>
          </div>
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-purple-500 text-white rounded-full flex items-center justify-center text-sm font-bold">3</div>
              <p className="text-sm text-gray-700"><strong>Publicación:</strong> El evento aparece en Aldebaran</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-orange-500 text-white rounded-full flex items-center justify-center text-sm font-bold">4</div>
              <p className="text-sm text-gray-700"><strong>Comunidad:</strong> Miles de corredores lo descubren</p>
            </div>
          </div>
        </div>
      </div>
